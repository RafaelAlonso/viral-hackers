class Prompts::LongVideoDefinitionConstraints < Prompts::Base
    def self.build(base_script)
        ...
        Apresentação_e_call_to_action_para_like: Exemplo: `Eu sou o [NOME DO INFLUENCIADOR], e se esse tema é interessante para você, já se inscreve no canal e aperta no like agora mesmo.`
        ...
        call_to_action_final: Aqui o usuário faz uma call uma call to action para onde preferir. Exemplo: `Se esse conteúdo fez sentido para você, clique no primeiro link da descrição e faça o download gratuito do meu ebook sobre ganho de massa muscular.`
